...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post solutions_url, params: { solution: { content_type: @solution.content_type, file_contents: @solution.file_contents, filename: @solution.filename, problem_id: @solution.problem_id, user_id: @solution.user_id } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { content_type: @solution.content_type, file_contents: @solution.file_contents, filename: @solution.filename, problem_id: @solution.problem_id, user_id: @solution.user_id } }
